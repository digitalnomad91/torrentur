@extends('layouts.app')
@section('title', 'Latest Torrents | 123Torrents - Torrent Search Engine')
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="pull-left">
                                <div id="hoverable-row-table">
                                    <h2>@php echo $category->Icon() @endphp Recent {{$category->title}} Torrents</h2>
                                </div>
                            </div>

                            <div class="pull-right">
                                <a href="/browse/movies" class="btn btn-default">View All</a>
                            </div>
                                        ...
                                        <table class="table pmd-table table-hover table-striped torrents_table">
                                            ...
                                            <tbody>
                                            	...
                                            	@php 
                                            		...
                                            		$movies = App\Torrent::select ('id', 'title', 'torrent_url', 'size', 'file_count', 'seeders', 'leechers', 'created_at', 'info_hash', 'category_id')->where("category_id", "=", $category->id)->orderBy("id", "DESC")->simplePaginate (10);
